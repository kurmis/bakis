...
Naudojami maketai buvo paleisti veikti 100MHz grei\v{c}iu. Abu maketai keisdavo i\v{s}\.ejimo prievado vieno i\v{s} i\v{s}vad\k{u} login\k{i} lyg\k{i}, bei buvo \k{i}jungtas nuo laiko priklausantis tu\v{s}\v{c}ias tr\=ukis. Osciloscopu matuotas i\v{s}vad\k{u} lygmen\k{u} kitimo laikas.
...
\indent Cortex-R4 generavo 280ns ilgio impulsus. \k{I}\.ejimo \k{i} tr\=uk\k{i} ir i\v{s}\.ejimo laikas 730ns. Cortex-M4 generavo 150ns ilgio impulsus. \k{I}\.ejimo \k{i} tr\=uk\k{i} ir i\v{s}\.ejimo laikas 200ns.
\begin{figure}[H] %--< nustatymai kur bus paveiksliukas h - kaip tekste, t - puslapio virsuje, b - puslapio apacioje, H - tiksliai kaip tekste, p - atskiram paveiksleliu pslapy >--%
\centering %--< lygiavimas >--%
...
\begin{enumerate}
\item RM48 esantis 64 bit\k{u} slankaus kablelio modulis nenaudojant speciali\k{u} bibliotek\k{u} leid\v{z}ia sutrumpinti dvigubo tikslumo slankaus kablelio skai\v{c}iavimus esant 100MHz lyginant su stm32f4 mikrovaldikliu.
\item Du procesoriai esantys R4 stipriai padidina mikrovaldiklio naudojam\k{a} gali\k{a}
\item RM48 mikrovaldiklis nenaudojant speciali\k{u} tr\=ukiu l\.e\v{c}iau perjungin\.eja periferij\k{a}.
\item RM48 ilgai u\v{z}trunka \k{i}einant ir i\v{s}einant i\v{s} tr\k{u}kio
\item Ma\v{z}iausia naudojama galia, kuri\v{a} pavyko pasiekti su RM48 yra 166 kartus didesn\.e nei ma\v{z}iausia vartojama galia, kuri\k{a} pavyko pasiekti su stm32f4 maketu
\item Mikrovaldikliams atliekant skirtingus skai\v{c}iavimus naudojama galia labiausiai priklauso nuo taktinio da\v{z}nio ir tik ne\v{z}ymiai nuo pa\v{c}i\k{u} skai\v{c}iavim\k{u}
\end{enumerate}
...
\indent
\v{S}iame darbe buvo pabandyta i\v{s}siai\v{s}kinti Hercules \v{s}eimos atstovo RM48 mikrovaldiklio energetin\k{i} efektyvum\k{a} ir bandyta palyginti su kitu \k{i}prastesniu mikrovaldikliu. Taip pat susipa\v{z}inta su 32 bit\v{u} Cortex \v{s}eimos programavimo ypatyb\.emis.
