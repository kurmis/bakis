...
\begin{itemize}
\item Periferija nustatyta \v{z}emame loginiame lygije:
\begin{itemize}
...
\item Cortex-R4 mikrovaldiklio periferija taisiklyngai nei\v{s}sijungia.
\item Mikrovaldiklis ap\v{s}vie\v{c}iamas rentgeno spinduliais veikia gerai tol, kol jame ivyksta strukt\={u}riniai pakitimai, po kuri\k{u} jis nebegali atlikti joki\k{u} funkcij\k{u}.
\end{enumerate}
