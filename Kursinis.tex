...
konstanta nuo tikrosios skiriasi $\pm3.55271 * 10^{-15}$. 
%\textcolor{gray}{\\
\begin{verbatim}
  int doubleTest() { 
    volatile int i; 
...
\end{verbatim}
%}
Naudojant viengubo tikslumo slankaus kablelio kintamuosius buvo ie\v{s}komas 120 narys. Konstanta nuo tikrosios skiriasi $\pm8.74228* 10{^-8}s$
\begin{verbatim}
int floatTest() {
  volatile int i;
...
\begin{verbatim}
short test_bits() {
  volatile unsigned sum = 0x55555555; // 0101 0101  0101 0101  0101 0101  0101 0101  
  ...
  return 0; // teste klaida
}
\end{verbatim}
\subsection{Greitas Furj\.e\ eilut\.es }
\newpage
