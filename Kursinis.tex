...
xRM48L950 turi du integruotus ARM Cortex-R4F procesori\k{u}, su slankaus kablelio aritmetikos moduliu. Procesoriai i\v{s}destyti skirtinga orientacija  
\begin{figure}[H] %--< nustatymai kur bus paveiksliukas h - kaip tekste, t - puslapio virsuje, b - puslapio apacioje, H - tiksliai kaip tekste, p - atskiram paveiksleliu pslapy >--%
\centering %--< lygiavimas >--%
...
\label{vienas}
\end{figure}
\k{I}renginys palaiko saves testavim\k{a}. Jo metu galima priversti procesori\k{u} i\v{s}\.ejimo signal\k{u} nesutapim\k{a}, taip patikrinama ar veikia procesori\k{u} palyginimo modulis ir ar irenginys sugeba atpa\v{z}inti klaidas. Procesoriai maitinami 1.2V \k{i}tampa.
...
SRAM ir Flash atminys turi ECC\footnote{ECC - error corection code} apsaug\k{a}. Tai rei\v{s}kia, kad yra galimyb\.e 1 bito klaidos aptikimui ir pataisymui, bei 2 bit\k{u} klaidos aptikimui. Flash atmintis maitinama 3.3V \k{i}tampa.
\subsubsection{Periferija}
