...
\end{verbatim}
\subsection{\k{I}\.ejimo ir i\v{s}\.ejimo \k{i} tr\=k\k{i} algoritmo apra\v{s}ymas}
Naudojami maketai buvo paleisti veikti 100MHz grei\v{c}iu. Abu maketai keisdavo i\v{s}\.ejimo porto vienos kojos login\k{i} lyg\k{i}, bei buvo \k{i}jungtas nuo laiko priklausantis tu\v{s}\v{c}ias tr\=kis. Osciloscopu matuota port\k{u} lygmen\k{u} kitimo laikas.
\subsection{Srov\.es matavimai}
Kadangi TMDXRM48USB maketas netur\.ejo trumpikli\k{u}   
\newpage
